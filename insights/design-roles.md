...
* **Specialist Roles**\
  These roles require deep expertise in a single area, such as backend development or UX research. Specialists are typically brought in for their specific knowledge and are crucial to solving complex challenges in their domain.
* **Generalist Roles**\
  Generalists have a broader skill set and can contribute to a variety of tasks. They are often valued in startups or smaller teams where flexibility and adaptability are key.

#### T-Shaped vs V-Shaped

* **T-Shaped Designers**\
  Designers with deep expertise in one area (such as visual design or interaction design) but also possess a broad understanding of related fields (like UX research or coding). This makes them adaptable and valuable in cross-functional teams.\\
* **V-Shaped Designers**\
  Designers who have deep specialisation in two or more areas, allowing them to take on more complex, integrated challenges. These designers can often bridge gaps between disciplines, making them ideal for projects requiring multifaceted expertise.

{% embed url="https://www.smashingmagazine.com/2024/06/t-shaped-vs-v-shaped-designers/" %}

{% embed url="https://medium.com/design-bootcamp/is-being-a-t-shaped-designer-still-relevant-2f9e38ebd28a" %}

#### Visual vs Spatial Thinkers
...
{% embed url="https://uxdesign.cc/heres-why-ux-teams-need-visual-and-spatial-thinkers-alike-ce5dc00ab6b1" %}
...
{% embed url="https://fs.blog/experts-vs-imitators/" %}

#### Vertical vs. Lateral Promotion
...
* **Matrix Structure**\
  Employees report to multiple managers, typically a project manager and a functional manager. This structure fosters collaboration but can lead to complexity in decision-making.
* **Hierarchical Structure**\
  Traditional top-down management structure where employees report to one manager. It's clear and straightforward but can lead to slower decision-making and less innovation.
