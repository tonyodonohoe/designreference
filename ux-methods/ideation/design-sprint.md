...
* **Day 1: Understand and Define the Problem**
  ...
  * **Activities**: Start with "[How Might We](how-might-we.md)" (HMW) notes, [map the user journey](../discovery/customer-journey-mapping.md), and hold lightning demos to examine existing solutions.
...
* **Day 2: Sketch Solutions**
  ...
  * **Activities**: Lead the team through exercises like "[Crazy 8s](crazy-eights.md)" for rapid ideation. Encourage everyone to produce a refined sketch of their best idea.
...
{% embed url="https://www.youtube.com/watch?v=E2cbamqy7Do" %}

#### Further Reading

{% embed url="http://www.gv.com/sprint/" %}

{% embed url="https://sprintstories.com/" %}

{% embed url="https://www.thesprintbook.com/" %}

{% embed url="https://uxplanet.org/the-adventure-of-a-design-sprint-34c15cd9be76" %}
