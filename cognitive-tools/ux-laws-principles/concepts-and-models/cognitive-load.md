---
description: >-
  The amount of mental effort required to use a system or understand
  information.
---
...
* Reduction Method: Manages Intrinsic Load by reducing the number of individual items the user must hold in working memory (see [Miller's Law](../psychology/millers-law.md)).
