---
description: >-
  Users rarely read manuals, preferring to jump in and figure out software
  immediately.
---
...
* Application: Make system behaviour immediately recognisable. Use clear affordances (e.g., buttons that look like buttons) and familiar icons. Instructions should be embedded _in context_, such as tooltips that appear only when the user hovers over a function for the first time.
