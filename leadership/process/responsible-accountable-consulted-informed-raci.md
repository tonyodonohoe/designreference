...
_Planning and executing a company event scenario._

| Task                              | Responsible   | Accountable     | Consulted                      | Informed                                     |
| --------------------------------- | ------------- | --------------- | ------------------------------ | -------------------------------------------- |
| Budgeting                         | Finance Team  | Finance Manager | Event Planner, HR              | Executive Team                               |
| Venue Selection                   | Event Planner | HR Manager      | Finance Team, Executive Team   | Entire Company                               |
| Activity Planning                 | Event Planner | HR Manager      | Team Leads, Employee Survey    | Entire Company                               |
| Logistics (Travel, Accommodation) | HR Team       | HR Manager      | Event Planner, Finance Team    | Executive Team, Participants                 |
| Food and Beverage                 | Event Planner | HR Manager      | Catering Company, Finance Team | Executive Team, Participants                 |
| Team Building Activities          | Event Planner | HR Manager      | Team Leads, Employee Survey    | Entire Company                               |
| Post-Event Survey and Feedback    | HR Team       | HR Manager      | Event Planner                  | <p>Executive Team</p><p>Export to Sheets</p> |
...
{% embed url="https://medium.com/@raphael.moutard/top-managers-are-abandoning-raci-for-impact-delegation-ef16517dfccf" %}
