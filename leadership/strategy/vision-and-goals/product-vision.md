...
However, design managers can also play a significant role in shaping and contributing to the product vision, especially in areas where user experience, design direction, and customer insights are crucial. While product managers focus on the broader strategic aspects, product design managers ensure that the product's design elements align with the vision, bringing in a user-centric perspective to the product development process.

In practice, product managers lead the creation of the Product Vision Board, and design managers contribute by helping articulate customer needs, product features, and ensuring the design fits within the product's strategic framework. Both roles collaborate closely to ensure that the vision is implemented effectively.

#### Further Reading

{% embed url="https://uxdesign.cc/how-to-think-strategically-as-a-designer-and-understand-product-vision-ebb79f922cd8" %}

{% embed url="https://uxdesign.cc/product-visioning-through-storytelling-3126f91808cc" %}

{% embed url="https://david-theil.medium.com/how-we-craft-better-product-visions-6df2c0981789" %}
