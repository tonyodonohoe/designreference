...
2. **Customer Perspective**\
   This perspective focuses on customer satisfaction, retention, and acquisition. It answers the question, "How do customers see us?"
3. **Internal Process Perspective**\
   This perspective focuses on the internal processes that drive the organization's performance, such as operational efficiency, product quality, and innovation. It answers the question, "What must we excel at?"
4. **Learning and Growth Perspective**\
   This perspective focuses on the organisation's ability to learn and grow, including employee skills, knowledge, and motivation. It answers the question, "Can we continue to improve and create value?"

#### Further Viewing

{% embed url="https://www.youtube.com/watch?v=C0JZdyb6hZE" %}

#### Further Reading

{% embed url="https://bettermarketing.pub/measure-what-matters-58320dc3582f" %}

{% embed url="https://online.hbs.edu/blog/post/balanced-scorecard" %}
